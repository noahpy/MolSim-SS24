 ...
 * @nosubgrouping
 */
class dimension_t: public ::xsd::cxx::tree::fundamental_base< ::xml_schema::integer, char, ::xml_schema::simple_type >
{
  public:
  /**
   * @name Constructors
...
#ifdef XSD_CXX11
  dimension_t&
  operator= (const dimension_t&) = default;
#endif
...
class cuboid_t: public ::xml_schema::type
{
   ...
   * instead of making copies.
   */
  cuboid_t (::std::unique_ptr< pos_type >,
...
class membrane_t: public ::xml_schema::type
{
   ...
   * @name equiDist
   *
   * @brief Accessor and modifier functions for the %equiDist
   * required element.
   *
   ...
   * @brief Element type.
   */
  typedef ::xml_schema::double_ equiDist_type;

  /**
   * @brief Element traits type.
   */
  typedef ::xsd::cxx::tree::traits< equiDist_type, char, ::xsd::cxx::tree::schema_type::double_ > equiDist_traits;
   ...
   * @name springConst
   *
   * @brief Accessor and modifier functions for the %springConst
   * required element.
   *
   ...
   * @brief Element type.
   */
  typedef ::xml_schema::double_ springConst_type;

  /**
   * @brief Element traits type.
   */
  typedef ::xsd::cxx::tree::traits< springConst_type, char, ::xsd::cxx::tree::schema_type::double_ > springConst_traits;
   ...
   * instead of making copies.
   */
  membrane_t (::std::unique_ptr< pos_type >,
              ::std::unique_ptr< vel_type >,
              ::std::unique_ptr< dim_type >,
              const mass_type&,
              const spacing_type&,
  ...
  ::xsd::cxx::tree::one< brownDim_type > brownDim_;
  ptype_optional ptype_;
  ::xsd::cxx::tree::one< equiDist_type > equiDist_;
  ::xsd::cxx::tree::one< springConst_type > springConst_;
...
class simulation_t: public ::xml_schema::type
{
   ...
   */
  void
  params (::std::unique_ptr< params_type > p);
   ...
   * initializers for required elements and attributes.
   */
  simulation_t (const params_type&,
                const clusters_type&);
   ...
   * instead of making copies.
   */
  simulation_t (::std::unique_ptr< params_type >,
                ::std::unique_ptr< clusters_type >);
...
void
operator<< (::xercesc::DOMElement&, const doubleVec_t&);

void
operator<< (::xercesc::DOMElement&, const intVec_t&);
