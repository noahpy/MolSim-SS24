...
DataArrayList_t::DataArrayList_t(
    const DataArrayList_t& o, ::xml_schema::flags f, ::xml_schema::container* c)
...
Points::DataArray_sequence& Points::DataArray()
{
    return this->DataArray_;
}

void Points::DataArray(const DataArray_sequence& s)
{
    this->DataArray_ = s;
}
...
DataArray_t::DataArray_t(
    const type_type& type, const Name_type& Name, const NumberOfComponents_type& NumberOfComponents)
    : ::DataArrayList_t()
    , type_(type, this)
    , Name_(Name, this)
...
DataArray_t::DataArray_t(
    const ::DataArrayList_t& _xsd_DataArrayList_t_base,
...
PieceUnstructuredGrid_t::PieceUnstructuredGrid_t(
    const PieceUnstructuredGrid_t& x, ::xml_schema::flags f, ::xml_schema::container* c)
...
PieceUnstructuredGrid_t* PieceUnstructuredGrid_t::_clone(
...
UnstructuredGrid_t::UnstructuredGrid_t(
    const UnstructuredGrid_t& x, ::xml_schema::flags f, ::xml_schema::container* c)
    : ::xml_schema::type(x, f, c)
...
UnstructuredGrid_t* UnstructuredGrid_t::_clone(
    ::xml_schema::flags f, ::xml_schema::container* c) const
{
...
const char* const type::_xsd_type_literals_[10] = { "Int8",    "UInt8",  "Int16", "UInt16",
                                                    "Int32",   "UInt32", "Int64", "UInt64",
                                                    "Float32", "Float64" };

const type::value type::_xsd_type_indexes_[10] = { ::type::Float32, ::type::Float64, ::type::Int16,
                                                   ::type::Int32,   ::type::Int64,   ::type::Int8,
...
::xml_schema::dom::unique_ptr<::xercesc::DOMDocument> VTKFile(
    const ::VTKFile_t& s, const ::xml_schema::namespace_infomap& m, ::xml_schema::flags f)
{
    ::xml_schema::dom::unique_ptr<::xercesc::DOMDocument> d(
...
void operator<<(::xercesc::DOMElement& e, const PointData& i)
{
    ...
    // DataArray
    //
    for (PointData::DataArray_const_iterator b(i.DataArray().begin()), n(i.DataArray().end());
         b != n;
         ++b) {
...
void operator<<(::xercesc::DOMElement& e, const CellData& i)
{
    ...
    // DataArray
    //
    for (CellData::DataArray_const_iterator b(i.DataArray().begin()), n(i.DataArray().end());
         b != n;
         ++b) {
...
void operator<<(::xercesc::DOMElement& e, const Points& i)
{
    ...
    // DataArray
    //
    for (Points::DataArray_const_iterator b(i.DataArray().begin()), n(i.DataArray().end()); b != n;
         ++b) {
...
void operator<<(::xercesc::DOMElement& e, const Cells& i)
{
    ...
    // DataArray
    //
    for (Cells::DataArray_const_iterator b(i.DataArray().begin()), n(i.DataArray().end()); b != n;
         ++b) {
