...
{
    // remove_if rearranged the elements in the vector, so we need to erase the elements after the last valid one
    particles.erase(std::remove_if(particles.begin(), particles.end(), [&particleMap](const Particle& p) {
