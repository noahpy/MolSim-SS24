 ...
 * CuboidParticleCluster cluster1 = CuboidParticleCluster(std::array<double, 3> {0,0,0},
 * 40,8,1, 1.1225, 1, std::array<double, 3> {0,0,0}, 0.1, 2); CuboidParticleCluster cluster2 =
 * CuboidParticleCluster(std::array<double, 3> {15,15,0}, 8,8,1, 1.1225, 1, std::array<double, 3>
 * {0,-10,0}, 0.1, 2);
 *
...
public:
     ...
     * @details Adds a cluster to the list of clusters to generate. The cluster can be generated by
     * calling generateClusters()
     ...
     * @details Generates the clusters into the container specified in the constructor. The clusters
     * are generated in the order they were registered and the vector containing the clusters will
     * be cleared after the generation
     * @attention This will set the vector of particles in the container. Call this method before
     * inserting single particles that do not belong to a cluster
     * @return void
     */
