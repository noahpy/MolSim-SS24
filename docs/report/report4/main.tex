...
\begin{itemize}
    ...
    \item The runtime of the small Rayleigh-Taylor simulation on the cluster can be viewed here Tab.\ \ref{table:small_raileigh}. Unfortunately, cluster scheduling did not leave us the time to run the bigger experiments on the cluster to get measurements from there.
\end{itemize}
